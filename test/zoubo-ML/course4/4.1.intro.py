...
if __name__ == "__main__":
    ...
    # print('c = \n', c)
    # print('d = \n', d)
    # s = np.stack((a, b, c, d), axis=0)  #数组堆叠
    # print('axis = 0 ', s.shape, '\n', s)
    # s = np.stack((a, b, c, d), axis=1)  #按行堆叠
    # print('axis = 1 ', s.shape, '\n', s)
    # s = np.stack((a, b, c, d), axis=2)  #按列堆叠
    ...
    # plt.plot(x, y, 'ro-', linewidth=2,markeredgecolor='k')  #mark是显示黑边
    ...
    # 6. 概率分布
    #6.1 均匀分布
    # x = np.random.rand(10000)  #真实数据
    # t = np.arange(len(x))  #观测数据
